...
<body>
	<div style="margin: auto">
		<div class="text-center mb-4">
			<h6 class="h3">이용 약관</h6>
		</div>
		<article class="card-body mx-auto" style="max-width: 400px;">
			<div class="checkbox_group">

				<input type="checkbox" id="check_all" class="check_all"> <label
					for="check_all">전체 동의</label><br> <input type="checkbox"
					id="check_1" name="chk" class="normal"> <label
					for="check_1">서비스 이용약관 동의(필수)</label><br>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<br> <input type="checkbox" id="check_2" name="chk"
					class="normal"> <label for="check_2">개인정보 처리방침
					동의(필수)</label><br>
				<textarea class="form-control" cols="100" rows="5"
					style="resize: none" readonly="readonly">
1. 개인정보의 처리 목적 (‘..’이하 ‘부동산 커뮤니티’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.

- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등

2. 개인정보의 처리 및 보유 기간

① (‘..’이하 ‘부동산 커뮤니티’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.
...
① ('..'이하 '부동산 커뮤니티')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② ('..')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.

1.
개인정보를 제공받는 자 : BS31
제공받는 자의 개인정보 이용목적 : 이메일, 비밀번호, 로그인ID, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록
제공받는 자의 보유.이용기간: 지체없이 파기


4. 개인정보처리 위탁

① ('부동산 커뮤니티')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

1. 
위탁받는 자 (수탁자) :
위탁하는 업무의 내용 :
위탁기간 :
② ('..'이하 '부동산 커뮤니티')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.

③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.

5. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.

① 정보주체는 BS31(‘..’이하 ‘부동산 커뮤니티) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
...
① ('..'이하 '부동산 커뮤니티')은(는) 다음의 개인정보 항목을 처리하고 있습니다.
...
7. 개인정보의 파기('부동산 커뮤니티')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
...
BS31 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.

9. 개인정보 보호책임자 작성

① BS31(‘..’이하 ‘부동산 커뮤니티) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
...
담당자 :000
연락처 :000, 000, 000
② 정보주체께서는 BS31(‘..’이하 ‘부동산 커뮤니티) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. BS31(‘..’이하 ‘부동산 커뮤니티) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
11. 개인정보의 안전성 확보 조치 ('부동산 커뮤니티')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
...
4. 해킹 등에 대비한 기술적 대책
BS31('부동산 커뮤니티')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
